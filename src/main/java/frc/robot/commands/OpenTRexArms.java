...
public class OpenTRexArms extends CommandBase {
  /**
   * Creates a new Shoot.
   */
  ...
  public OpenTRexArms(TRexArms _tRexArms) {
  ...
  @Override
  public void execute() {
    m_tRexArms.runClapper(ElbowMotorConstants.outPos, ElbowMotorConstants.outPos);
    m_tRexArms.runTapper(0);
  }
